...
class LocationMenu extends StatefulWidget {
  ...
  const LocationMenu({super.key, required this.menuItems, required this.selectedIndex, required this.onItemTapped});
...
class _LocationMenuState extends State<LocationMenu> {
  ...
  buildMenuItem(String menuItem, bool selectionState, int i) {
    return GestureDetector(
      ...
      child: Text(menuItem,style: const TextStyle(color: Colors.black,fontSize: 20),),
      ),
    );
  }
}